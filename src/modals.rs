...
use egui_material_icons::icons::{
    ICON_BACKUP, ICON_BOOKMARK_MANAGER, ICON_CLOSE, ICON_DELETE, ICON_FOLDER_OPEN, ICON_KEY,
    ICON_LOCK, ICON_UPDATE, ICON_WARNING,
};
use rfd::FileDialog;

// Internal modules usage
use crate::{MindSafeApp, models::note::Note};
    ...
    egui::Window::new("Delete Note")
        ...
        .show(ctx, |ui| {
            ui.vertical(|ui| {
                ...
                ui.add(
                    // NOTE: reusing this password, instead of creating new var (confirm) for this!!
                    TextEdit::singleline(&mut app.password)
                        .char_limit(60)
